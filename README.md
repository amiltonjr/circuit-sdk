...
[![GitHub release](https://img.shields.io/github/release/circuit/circuit-sdk.svg)](https://github.com/amiltonjr/circuit-sdk)
[![Build Status](https://travis-ci.org/circuit/circuit-sdk.svg?branch=master)](https://travis-ci.org/amiltonjr/circuit-sdk)
...
Help us improve the SDK or examples by sending us a pull-request or opening a [GitHub Issue](https://github.com/amiltonjr/circuit-sdk/issues/new).
